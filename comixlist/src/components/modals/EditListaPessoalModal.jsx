...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      const editedData = {
        user: user.uid, // Passa o ID do usuário.
        serieId: initialData.serieId, // Passa o ID da série.
      ...
      console.log('Dados a serem editados:', editedData); // Verifique se os dados estão corretos aqui.
